...
/**
 * Date & Time: 2023-06-22 20:53
 *
 * @author <a href="mailto:askar.ghandchi@gmail.com">Askar Ghandchi</a>
 * @version 1.0
 */
@Component
@Order(-2) // The order is set to -2 to be handled before spring one
public class GlobalErrorWebExceptionHandler extends AbstractErrorWebExceptionHandler {
    ...
    private Mono<ServerResponse> renderErrorResponse(ServerRequest request) {
        ...
        // Removing unwanted message attributes
        ...
        HttpStatusCode status = (HttpStatus) errorPropertiesMap.get("status");

        // Replacing HTTP status code
